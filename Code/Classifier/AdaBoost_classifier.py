...
y=label
sepscores = []
cv_clf = AdaBoostClassifier(base_estimator=None, n_estimators=20)
...
yscore_sum.to_csv('yscore_sum_ada.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_ada.csv')
